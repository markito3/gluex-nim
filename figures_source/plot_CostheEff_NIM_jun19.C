...
// ------------>Primitives in pad: c1_2
   ...
   Graph_Graph01002->GetXaxis()->SetLabelSize(0.07);
   Graph_Graph01002->GetXaxis()->SetTitleSize(0.07);
   ...
   Graph_Graph01002->GetYaxis()->SetLabelSize(0.07);
   Graph_Graph01002->GetYaxis()->SetTitleSize(0.07);
   Graph_Graph01002->GetYaxis()->SetTitleOffset(0);
   Graph_Graph01002->GetYaxis()->SetTitleFont(42);
   Graph_Graph01002->GetYaxis()->SetNdivisions(505);
    Graph_Graph01002->GetZaxis()->SetLabelFont(42);
   Graph_Graph01002->GetZaxis()->SetLabelSize(0.07);
   Graph_Graph01002->GetZaxis()->SetTitleSize(0.07);
...
// ------------>Primitives in pad: c1_3
   ...
   Graph_Graph01003->GetXaxis()->SetLabelSize(0.07);
   Graph_Graph01003->GetXaxis()->SetTitleSize(0.07);
   ...
   Graph_Graph01003->GetYaxis()->SetLabelSize(0.07);
   Graph_Graph01003->GetYaxis()->SetTitleSize(0.07);
   ...
   Graph_Graph01003->GetYaxis()->SetNdivisions(505);
    Graph_Graph01003->GetZaxis()->SetLabelSize(0.07);
   Graph_Graph01003->GetZaxis()->SetTitleSize(0.07);
   ...
   c1->SetSelected(c1);
    ...
    c1->SaveAs("plot_CostheEff_NIM_jun19.pdf");
}
