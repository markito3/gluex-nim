...
The layouts of the Hall D beamline and Tagger Hall are shown in Figures~\ref{fig:beam:halld-tot} and \ref{fig:beam:tagger-hall}. The dimensions are measured in centimeters unless
specified differently. The origin is located 50.8~cm (20 inches) downstream of the front side of the front endplate of the solenoid. 
