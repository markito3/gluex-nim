...
{\color{red} Comment by Stuart: Some of the detail here, e.g.~the specific naming of the beam position monitors, may be more suited to a dedicated beamline paper, rather than the intended overview provided by this document}
...
The counter assemblies also have 2-stage preamplifiers mounted on them, providing high voltage input, and TDC and fADC signal outputs.
...
reconstructed photon energies between 6~GeV and 12.4~GeV. The relatively
