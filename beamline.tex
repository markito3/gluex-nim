...
An example of the
measured photon spectrum and polarization with a 12\,GeV electron beam is
...
to cover between 8.2 and 9.2~GeV in photon energy, but TAGM is designed to be movable should a
different peak energy be desired. The microscope is segmented along the horizontal axis into
