...
Hall D diamonds are typically 50 $\mu m$ thick.
...
{\color{red} Comments by Elton: Need to describe the system: Arrangement and number of fibers? Type of fibers with references, references to SiPMs, short description of electronics, energy granularity, energy resolution (e.g. relative to PS), timing resolution, rate capability, summary of operational experience (size of signals in detector, etc.}
...
The broad coverage aids in alignment of the diamond radiator and expands the \GX{} physics program reach beyond just the coherent peak.
...
The counter assemblies also have 2-stage preamplifiers mounted on them, with have high voltage input, and TDC and fADC signal outputs.
...
{\color{red} Comments by Elton: Need more information on geometry (e.g. three rows of counters), description of scintillators and pmts. What is the rate capability of the system? What were typical rates during production running? What is the timing resolution? What is the energy granularity? What is the energy resolution (e.g. compared to PS)?}
...
The Hall D primary collimator provides apertures of 3.4 mm and 5.0 mm in a tungsten plate mounted on an X-Y table.
The entire collimator is surrounded by lead shielding.
In normal \GX{} running conditions, the 5.0 mm collimator is used.
...
{\color{red} Comments by Elton: Need to add a short description of the setup (high granularity and coarse array); What range of energies is covered? (Can refer back to Fig with photon flux and polarization) What is the timing resolution? Rate of PS triggers? What is the energy resolution? Stability of the system?}

{\color{red} Comment by Stuart: Some of this information is contained in a commented out section of the tex file, from the TCR. I'll look at restoring some of this descriptive text}
