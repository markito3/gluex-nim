...
Technology\cite{Eljen-reference} was selected. EJ-200 has a decay time
of 2.1 ns and a long attenuation
length\cite{scint-reference-for-start-counter}. Silicon
...
their final shape, including edges beveled at 6^degrees to minimize
loss of acceptance.
