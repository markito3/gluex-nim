...
The \ST consist of 30 scintillor paddles arranged in a cylinder for most of
...
There is one ST2 board for each ST1 board and it services the
corresponding three electronic channels. For each channel there is a
pre-amplifier whose output is split, one side of the signal goes to a
buffer and then to a Flash ADC, the other goes to a
5$\times$~amplifier and is sent to a discriminator and from there to a
TDC.
