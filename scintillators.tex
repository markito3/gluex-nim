...
The Start Counter detector, shown in Fig.\ ??? surrounds the target region and covers about 90 of the solid angle for particles originating from the center of the target. It is designed to perate at tagged photon beam intensities of up to $10^8$ photons per second in the coherent peak. It has a high degree of segmentation to limit the the per-paddle rates. The time resolution is less than 350 ps RMS. 
